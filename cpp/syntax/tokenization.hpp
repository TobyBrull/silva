...
namespace silva {
  struct tokenization_t : public menhir_t {
    ...
    friend void stream_out_impl(stream_t*, const tokenization_t&);
  };
  ...
  struct token_position_t {
    ...
    friend void stream_out_impl(stream_t*, const token_position_t&);
  };
  ...
  struct token_range_t {
    ...
    friend void stream_out_impl(stream_t*, const token_range_t&);
  };
