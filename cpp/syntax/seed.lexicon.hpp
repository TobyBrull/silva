...
namespace silva::seed {
  struct lexicon_t {
    ...
    token_id_t ti_slash        = *sfp->token_id("/");
    ...
    token_id_t ti_tokenizer    = *sfp->token_id("tokenizer");
    token_id_t ti_include      = *sfp->token_id("include");
    token_id_t ti_ignore       = *sfp->token_id("ignore");
    token_id_t ti_triple_colon = *sfp->token_id(":::");
    token_id_t ti_backslash    = *sfp->token_id("\\");
    token_id_t ti_pipe         = *sfp->token_id("|");
    ...
    name_id_t ni_tok             = sfp->name_id_of(ni_seed, "Tokenizer");
    name_id_t ni_tok_inc_rule    = sfp->name_id_of(ni_tok, "IncludeRule");
    name_id_t ni_tok_ign_rule    = sfp->name_id_of(ni_tok, "IgnoreRule");
    name_id_t ni_tok_tok_rule    = sfp->name_id_of(ni_tok, "TokenRule");
    name_id_t ni_tok_defn        = sfp->name_id_of(ni_tok, "Defn");
    name_id_t ni_tok_prefix_item = sfp->name_id_of(ni_tok, "PrefixItem");
    name_id_t ni_tok_item        = sfp->name_id_of(ni_tok, "Item");
    name_id_t ni_tok_matcher     = sfp->name_id_of(ni_tok, "Matcher");
    name_id_t ni_tok_list        = sfp->name_id_of(ni_tok, "List");
    name_id_t ni_tok_frag_name   = sfp->name_id_of(ni_tok, "FragName");
  };
}
