...
namespace silva {
  ...
  unique_ptr_t<seed::seed_engine_t> standard_seed_engine(syntax_ward_ptr_t swp)
  {
    auto retval = std::make_unique<seed::seed_engine_t>(swp);
    ...
    retval->parse_callbacks[swp->name_id_of("Seed")] =
        seed::seed_engine_t::callback_t::make<&seed::seed_engine_t::add_copy>(retval.get());
    return retval;
  }
}
