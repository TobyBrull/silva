...
namespace silva::test {
  ...
  run_parse_axe(syntax_ward_t& sw, const parse_axe_t& parse_axe, tokenization_ptr_t tp)
  {
  ...
  template<typename ParseAxeNursery>
  void test_parse_axe(syntax_ward_ptr_t swp,
  ...
  TEST_CASE("parse-axe-basic", "[parse_axe_t]")
  {
    ...
    const auto pa =
        SILVA_EXPECT_REQUIRE(parse_axe_create(sw.ptr(), sw.name_id_of("expr"), level_descs));
    ...
    test::test_parse_axe<test_nursery_t>(sw.ptr(), pa, "1", R"(
[0]_.test.atom                                    1
)");
    test::test_parse_axe<test_nursery_t>(sw.ptr(), pa, "1 + 2", R"(
[0]_.expr.add.+                                   1 + 2
  [0]_.test.atom                                  1
  [1]_.test.atom                                  2
)");
...
[0]_.expr.add.-                                   1 - 2
  ...
  [1]_.test.atom                                  2
    ...
    test::test_parse_axe<test_nursery_t>(sw.ptr(), pa, "1 + 2 * 3 + 4", R"(
[0]_.expr.add.+                                   1 + ... + 4
  [0]_.expr.add.+                                 1 + 2 * 3
    [0]_.test.atom                                1
    [1]_.expr.mul.*                               2 * 3
  ...
  [1]_.test.atom                                  4
    ...
    test::test_parse_axe<test_nursery_t>(sw.ptr(),
                                         pa,
                                         "1 - 2 + f . g . h * 3 / 4",
                                         R"(
[0]_.expr.add.+                                   1 - ... / 4
  ...
  [1]_.expr.mul./                                 f . ... / 4
    ...
    test::test_parse_axe<test_nursery_t>(sw.ptr(), pa, "2 ! + 3", R"(
[0]_.expr.add.+                                   2 ! + 3
  [0]_.expr.exc.!                                 2 !
    [0]_.test.atom                                2
  [1]_.test.atom                                  3
...
[0]_.expr.prf.-                                   - + 1
  [0]_.expr.prf.+                                 + 1
    ...
    test::test_parse_axe<test_nursery_t>(sw.ptr(), pa, "a + - + 1", R"(
[0]_.expr.add.+                                   a + - + 1
  [0]_.test.atom                                  a
  [1]_.expr.prf.-                                 - + 1
    [0]_.expr.prf.+                               + 1
...
[0]_.expr.add.+                                   1 + 2 !
  ...
  [1]_.expr.exc.!                                 2 !
    ...
    test::test_parse_axe<test_nursery_t>(sw.ptr(), pa, "2 ! . 3", none);
    test::test_parse_axe<test_nursery_t>(sw.ptr(), pa, "2 . - 3", none);
    test::test_parse_axe<test_nursery_t>(sw.ptr(), pa, "2 $ !", R"(
[0]_.expr.exc.!                                   2 $ !
  [0]_.expr.dol.$                                 2 $
    [0]_.test.atom                                2
)");
    test::test_parse_axe<test_nursery_t>(sw.ptr(), pa, "2 ! $", none);
    test::test_parse_axe<test_nursery_t>(sw.ptr(), pa, "+ ~ 2", R"(
[0]_.expr.prf.+                                   + ~ 2
  [0]_.expr.til.~                                 ~ 2
    [0]_.test.atom                                2
    ...
    test::test_parse_axe<test_nursery_t>(sw.ptr(), pa, "~ + 2", none);
    test::test_parse_axe<test_nursery_t>(sw.ptr(), pa, "( ( 0 ) )", R"(
[0]_.expr.nst.(                                   ( ( 0 ) )
  [0]_.expr.nst.(                                 ( 0 )
    [0]_.test.atom                                0
)");
...
[0]_.expr.mul.*                                   1 * ... * 4
  ...
  [1]_.test.atom                                  4
    ...
    test::test_parse_axe<test_nursery_t>(sw.ptr(), pa, "a [ 0 ]", R"(
[0]_.expr.sub.[                                   a [ 0 ]
  [0]_.test.atom                                  a
  [1]_.test.atom                                  0
)");
    test::test_parse_axe<test_nursery_t>(sw.ptr(), pa, "a [ 0 ] [ 1 ]", R"(
[0]_.expr.sub.[                                   a [ ... 1 ]
  [0]_.expr.sub.[                                 a [ 0 ]
    [0]_.test.atom                                a
    [1]_.test.atom                                0
  [1]_.test.atom                                  1
    ...
    test::test_parse_axe<test_nursery_t>(sw.ptr(), pa, "a [ 0 ] . b [ 1 ]", none);
    test::test_parse_axe<test_nursery_t>(sw.ptr(), pa, "a [ 0 ] + b [ 1 ]", R"(
[0]_.expr.add.+                                   a [ ... 1 ]
  [0]_.expr.sub.[                                 a [ 0 ]
    [0]_.test.atom                                a
    [1]_.test.atom                                0
  [1]_.expr.sub.[                                 b [ 1 ]
    ...
    test::test_parse_axe<test_nursery_t>(sw.ptr(), pa, "a ? b : c", R"(
[0]_.expr.ter.?                                   a ? b : c
  [0]_.test.atom                                  a
  [1]_.test.atom                                  b
  [2]_.test.atom                                  c
)");
    test::test_parse_axe<test_nursery_t>(sw.ptr(), pa, "a ? b : c ? d : e", R"(
[0]_.expr.ter.?                                   a ? ... : e
  [0]_.test.atom                                  a
  [1]_.test.atom                                  b
  [2]_.expr.ter.?                                 c ? d : e
...
[0]_.expr.ter.?                                   a ? ... : e
  ...
  [2]_.test.atom                                  e
    ...
    test::test_parse_axe<test_nursery_t>(sw.ptr(), pa, "a = b ? c = d : e = f", R"(
[0]_.expr.eqa.=                                   a = ... = f
  [0]_.test.atom                                  a
  [1]_.expr.eqa.=                                 b ? ... = f
    [0]_.expr.ter.?                               b ? ... : e
...
[0]_.expr.ter.?                                   a + ... + f
  ...
  TEST_CASE("parse-axe-advanced", "[parse_axe_t]")
  {
    ...
    test::test_parse_axe<test_nursery_t>(sw.ptr(), pa, "x y z", R"(
[0]_.expr.cat.cc                                  x y z
  ...
  [1]_.test.atom                                  z
    ...
    test::test_parse_axe<test_nursery_t>(sw.ptr(), pa, "{ b } a", R"(
[0]_.expr.prf_lo.{                                { b } a
  [0]_.test.atom                                  b
  [1]_.test.atom                                  a
)");
    test::test_parse_axe<test_nursery_t>(sw.ptr(), pa, "a { b } c", none);
    test::test_parse_axe<test_nursery_t>(sw.ptr(), pa, "a ( b ) c", R"(
...
[0]_.expr.cat.cc                                  a << ... c >>
  ...
  [1]_.expr.nst.<<                                << { ... c >>
    ...
    test::test_parse_axe<test_nursery_t>(sw.ptr(), pa, "<< a { b } >> c", none);
    test::test_parse_axe<test_nursery_t>(sw.ptr(), pa, "x 1 x z", none);
    test::test_parse_axe<test_nursery_t>(sw.ptr(), pa, "x 1 { z", R"(
...
[0]_.expr.add.+                                   a + ... + f
  ...
  [4]_.test.atom                                  f
    ...
    test::test_parse_axe<test_nursery_t>(sw.ptr(), pa, "a + b + c - d - e + f + g", R"(
[0]_.expr.add.+                                   a + ... + g
  [0]_.expr.add.-                                 a + ... - e
    [0]_.expr.add.-                               a + ... - d
      [0]_.expr.add.+                             a + b + c
