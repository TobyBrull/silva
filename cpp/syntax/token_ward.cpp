...
namespace silva {
  ...
  token_ward_t::~token_ward_t() = default;

  expected_t<token_id_t> token_ward_t::token_id(const string_view_t token_str)
  {
  ...
  expected_t<token_id_t> token_ward_t::token_id_in_string(const token_id_t ti)
  {
    const string_t str{SILVA_EXPECT_FWD(token_infos[ti].string_as_plain_contained())};
    return token_id(str);
  }

  name_id_t token_ward_t::name_id(const name_id_t parent_name, const token_id_t base_name)
  {
  ...
  bool token_ward_t::name_id_is_parent(const name_id_t parent_name, token_id_t child_name) const
  {
    while (true) {
  ...
  name_id_t token_ward_t::name_id_lca(const name_id_t lhs, const name_id_t rhs) const
  {
  ...
  const name_id_style_t& token_ward_t::default_name_id_style() const
  {
