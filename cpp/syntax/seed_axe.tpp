...
namespace silva::seed::test {
  ...
  TEST_CASE("seed-axe-basic", "[seed::axe_t]")
  {
    ...
    test::test_axe<test_nursery_t>(*se, sa, "1", R"(
[0]_.Test.Atom                                    1
)");
    test::test_axe<test_nursery_t>(*se, sa, "1 + 2", R"(
[0]_.Expr.Add.+                                   1 + 2
  [0]_.Test.Atom                                  1
  [1]_.Test.Atom                                  2
)");
...
[0]_.Expr.Add.-                                   1 - 2
  ...
  [1]_.Test.Atom                                  2
    ...
    test::test_axe<test_nursery_t>(*se, sa, "1 + 2 * 3 + 4", R"(
[0]_.Expr.Add.+                                   1 + ... + 4
  [0]_.Expr.Add.+                                 1 + 2 * 3
    [0]_.Test.Atom                                1
    [1]_.Expr.Mul.*                               2 * 3
...
[0]_.Expr.Add.+                                   1 - ... / 4
  ...
  [1]_.Expr.Mul./                                 f . ... / 4
    ...
    test::test_axe<test_nursery_t>(*se, sa, "2 ! + 3", R"(
[0]_.Expr.Add.+                                   2 ! + 3
  [0]_.Expr.Exc.!                                 2 !
    [0]_.Test.Atom                                2
  [1]_.Test.Atom                                  3
...
[0]_.Expr.Prf.-                                   - + 1
  [0]_.Expr.Prf.+                                 + 1
    ...
    test::test_axe<test_nursery_t>(*se, sa, "a + - + 1", R"(
[0]_.Expr.Add.+                                   a + - + 1
  [0]_.Test.Atom                                  a
  [1]_.Expr.Prf.-                                 - + 1
    [0]_.Expr.Prf.+                               + 1
...
[0]_.Expr.Add.+                                   1 + 2 !
  ...
  [1]_.Expr.Exc.!                                 2 !
    ...
    test::test_axe<test_nursery_t>(*se, sa, "2 ! . 3", {none});
    test::test_axe<test_nursery_t>(*se, sa, "2 . - 3", {none});
    test::test_axe<test_nursery_t>(*se, sa, "2 $ !", R"(
[0]_.Expr.Exc.!                                   2 $ !
  [0]_.Expr.Dol.$                                 2 $
    [0]_.Test.Atom                                2
)");
    test::test_axe<test_nursery_t>(*se, sa, "2 ! $", {none});
    test::test_axe<test_nursery_t>(*se, sa, "+ ~ 2", R"(
[0]_.Expr.Prf.+                                   + ~ 2
  [0]_.Expr.Til.~                                 ~ 2
    [0]_.Test.Atom                                2
    ...
    test::test_axe<test_nursery_t>(*se, sa, "~ + 2", {none});
    test::test_axe<test_nursery_t>(*se, sa, "( ( 0 ) )", R"(
[0]_.Expr.Nst.(                                   ( ( 0 ) )
  [0]_.Expr.Nst.(                                 ( 0 )
    [0]_.Test.Atom                                0
)");
...
[0]_.Expr.Mul.*                                   1 * ... * 4
  ...
  [1]_.Test.Atom                                  4
    ...
    test::test_axe<test_nursery_t>(*se, sa, "a [ 0 ]", R"(
[0]_.Expr.Sub.[                                   a [ 0 ]
  [0]_.Test.Atom                                  a
  [1]_.Test.Atom                                  0
)");
    test::test_axe<test_nursery_t>(*se, sa, "a [ 0 ] [ 1 ]", R"(
[0]_.Expr.Sub.[                                   a [ ... 1 ]
  [0]_.Expr.Sub.[                                 a [ 0 ]
    [0]_.Test.Atom                                a
    [1]_.Test.Atom                                0
  [1]_.Test.Atom                                  1
    ...
    test::test_axe<test_nursery_t>(*se, sa, "a [ 0 ] . b [ 1 ]", {none});
    test::test_axe<test_nursery_t>(*se, sa, "a [ 0 ] + b [ 1 ]", R"(
[0]_.Expr.Add.+                                   a [ ... 1 ]
  [0]_.Expr.Sub.[                                 a [ 0 ]
    [0]_.Test.Atom                                a
    [1]_.Test.Atom                                0
  [1]_.Expr.Sub.[                                 b [ 1 ]
    ...
    test::test_axe<test_nursery_t>(*se, sa, "a ? b : c", R"(
[0]_.Expr.Ter.?                                   a ? b : c
  [0]_.Test.Atom                                  a
  [1]_.Test.Atom                                  b
  [2]_.Test.Atom                                  c
)");
    test::test_axe<test_nursery_t>(*se, sa, "a ? b : c ? d : e", R"(
[0]_.Expr.Ter.?                                   a ? ... : e
  [0]_.Test.Atom                                  a
  [1]_.Test.Atom                                  b
  [2]_.Expr.Ter.?                                 c ? d : e
...
[0]_.Expr.Ter.?                                   a ? ... : e
  ...
  [2]_.Test.Atom                                  e
    ...
    test::test_axe<test_nursery_t>(*se, sa, "a = b ? c = d : e = f", R"(
[0]_.Expr.Eqa.=                                   a = ... = f
  [0]_.Test.Atom                                  a
  [1]_.Expr.Eqa.=                                 b ? ... = f
    [0]_.Expr.Ter.?                               b ? ... : e
...
[0]_.Expr.Ter.?                                   a + ... + f
  ...
  TEST_CASE("seed-axe-advanced", "[seed::axe_t]")
  {
    struct test_nursery_t : public parse_tree_nursery_t {
      ...
      expected_t<parse_tree_node_t> atom()
      {
        ...
        if (token_category_by() == lexicon.ti_number) {
          ...
          SILVA_EXPECT(token_category_by() == lexicon.ti_identifier, MINOR);
          token_index += 1;
        }
        return ss_rule.commit();
      }
    ...
    test::test_axe<test_nursery_t>(*se, sa, "x", R"(
[0]_.Test.Atom                                    x
)");
    test::test_axe<test_nursery_t>(*se, sa, "x y z", R"(
[0]_.Expr.Cat.concat                              x y z
  ...
  [1]_.Test.Atom                                  z
    ...
    test::test_axe<test_nursery_t>(*se, sa, "<: :> a", R"(
[0]_.Expr.Prf_lo.<:                               <: :> a
  [0]_.Test.Args                                  
  [1]_.Test.Atom                                  a
)");
    test::test_axe<test_nursery_t>(*se, sa, "<: 'foo' :> a", R"(
[0]_.Expr.Prf_lo.<:                               <: 'foo' :> a
  [0]_.Test.Args                                  'foo'
    [0]_.Test.Arg                                 'foo'
  [1]_.Test.Atom                                  a
)");
    test::test_axe<test_nursery_t>(*se, sa, "<: 'foo' , 'bar' , 'baz' :> a", R"(
[0]_.Expr.Prf_lo.<:                               <: 'foo' ... :> a
  ...
  [1]_.Test.Atom                                  a
    ...
    test::test_axe<test_nursery_t>(*se, sa, "x * <: 'foo' , 'bar' , 'baz' :> a", R"(
[0]_.Expr.Mul.*                                   x * ... :> a
  [0]_.Test.Atom                                  x
  [1]_.Expr.Prf_lo.<:                             <: 'foo' ... :> a
    ...
    test::test_axe<test_nursery_t>(*se, sa, "{ b } a", R"(
[0]_.Expr.Prf_lo.{                                { b } a
  [0]_.Test.Atom                                  b
  [1]_.Test.Atom                                  a
)");
    test::test_axe<test_nursery_t>(*se, sa, "a { b } c", {none});
    test::test_axe<test_nursery_t>(*se, sa, "a ( b ) c", R"(
...
[0]_.Expr.Cat.concat                              a << ... c >>
  ...
  [1]_.Expr.Prf_lo.{                              { b } c
    ...
    test::test_axe<test_nursery_t>(*se, sa, "<< a { b } >> c", {none});
    test::test_axe<test_nursery_t>(*se, sa, "x 1 x z", {none});
    test::test_axe<test_nursery_t>(*se, sa, "x 1 { z", R"(
...
[0]_.Expr.Add.+                                   a + ... + f
  ...
  [4]_.Test.Atom                                  f
    ...
    test::test_axe<test_nursery_t>(*se, sa, "a + b + c - d - e + f + g", R"(
[0]_.Expr.Add.+                                   a + ... + g
  [0]_.Expr.Add.-                                 a + ... - e
    [0]_.Expr.Add.-                               a + ... - d
      [0]_.Expr.Add.+                             a + b + c
