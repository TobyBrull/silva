...
namespace silva {
  ...
  namespace impl {
    struct seed_parse_tree_nursery_t : public parse_tree_nursery_t {
      ...
      full_name_id_t fni_alias       = tcp->full_name_id_of(fni_seed, "Alias");
      ...
      {
        auto gg_rule = guard_for_rule();
        gg_rule.set_rule_name(fni_nt_base);
