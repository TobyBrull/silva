...
namespace silva::test {
  ...
  {
    any_vector_t<hash_t, pretty_write_string_t, move_ctor_t, dtor_t> av(64);
    ...
    CHECK(av.apply(i1, pretty_write_string) == "Hello");
    CHECK(av.apply(i2, pretty_write_string) == "314");
    CHECK(av.apply(i3, pretty_write_string) == "[5 1 3]");
    CHECK(av.size() == 3);
    CHECK(av.byte_size() ==
    ...
    CHECK(av.size() == 3);
    CHECK(av.apply(i1, pretty_write_string) == "Hello");
    CHECK(av.apply(i4, pretty_write_string) == "[42 1.5]");
    CHECK(av.apply(i5, pretty_write_string) == "[123 2.5]");
    const auto i6 = av.push_back("World");
    CHECK(av.apply(i6, pretty_write_string) == "World");
  }
}
