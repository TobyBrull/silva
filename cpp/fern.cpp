...
namespace silva {
  ...
  unique_ptr_t<seed_engine_t> fern_seed_engine(syntax_context_ptr_t tcp)
  {
  ...
  {
    syntax_context_ptr_t tcp     = pt->tokenization->context;
  ...
  namespace impl {
    struct fern_nursery_t {
      ...
      syntax_context_ptr_t tcp       = parse_tree->tokenization->context;
