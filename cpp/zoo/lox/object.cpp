...
#undef OBJECT_IMPL
  ...
  expected_t<object_ref_t> scope_t::get(const token_id_t ti) const
  {
  ...
  expected_t<void> scope_t::assign(const token_id_t ti, object_ref_t x)
  {
    scope_t* sp = this;
    while (true) {
  ...
  expected_t<void> scope_t::define(const token_id_t ti, object_ref_t x)
  {
